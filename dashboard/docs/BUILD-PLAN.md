> **In-repo copy** of superlooper's PLAN-2026-07-07-command-center-mvp.md, vendored at Task 0
> completion so loop issues can point at it without cross-repo reads. It is a MAP, not the
> territory: §C/§D are a scout snapshot from 2026-07-07 — verify against current code as you
> build. The design constitution is docs/DESIGN-RECORD.md; its §0 rulings are fixed points.
